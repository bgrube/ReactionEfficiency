...
Second test: define histograms in parent process and run RDataFrame event loop in child
process. Call ROOT.ROOT.EnableImplicitMT() in parent process.
"""
...
def fill_hists_worker(hists, rhists):
    for rhist in rhists:
        hist = rhist.GetValue()
